...
function renderNewsItems(newsData, containerId) {
    ...
    newsData.forEach(newsItem => {
        ...
        const dateEndHighlight = document.createElement('div');
        dateEndHighlight.className = 'year-highlight';
        dateEndHighlight.textContent = newsItem.date_start;
        const dateStartHighlight = document.createElement('div');
        dateStartHighlight.className = 'year-highlight';
        dateStartHighlight.textContent = newsItem.date_end;
        console.log(newsItem)
        dateElement.appendChild(dateStartHighlight);
        dateElement.appendChild(dateEndHighlight);
